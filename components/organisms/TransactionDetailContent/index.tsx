                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <Row label="Your Game ID" value="Adham Shultan" />
                                <Row label="Order ID" value="#001" />
                                <Row label="Item" value="200 Diamonds" />
                            ...
                            <div className="payment pt-10 pb-10">
                                ...
                                <Row label="Your Account Name" value="Adham Shultan" />
                                <Row label="Type" value="Worldwide Transfer" />
                                <Row label="Bank Name" value="Mandiri" />
                                <Row label="Bank Account Name" value="PT Beraq Store" />
                                <Row label="Bank Number" value="1800 - 9090 - 2021" />
                            </div>
                            <div className="d-md-block d-flex flex-column w-100">
                                <a className="btn btn-whatsapp rounded-pill fw-medium text-white border-0 text-lg" href="whatsapp://send?text=Hello&phone=+6285156068704"
