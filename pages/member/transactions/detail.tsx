        ...
        <section className="sidebar">
            <div className="content pt-50 pb-30 ps-30">
                <div className="user text-center pb-50 pe-30">
                    ...
                    <h2 className="fw-bold text-xl color-palette-1 m-0">Adham Shultan</h2>
                    <p className="color-palette-2 m-0">Adham@Shultan.com</p>
                </div>
                <div className="menus">
                    <div className="item mb-30">
                        ...
                        <p className="item-title m-0">
                            <a href="../member" className="text-lg text-decoration-none">Overview</a>
                        </p>
                    </div>
                    ...
                    <div className="item mb-30">
                        ...
                        <p className="item-title m-0">
                            <a href="sign-in" className="text-lg text-decoration-none">Log Out</a>
                        </p>
                    </div>
                </div>
            </div>
